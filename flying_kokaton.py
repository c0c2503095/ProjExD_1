...
def main():
    ...
    while True:
        ...
        if key_lst[pg.K_UP]:
            move_jyouge -= 1#10-4：こうかとんの上移動

        if key_lst[pg.K_DOWN]:
            move_jyouge += 1#10-4：こうかとんの下移動 

        if key_lst[pg.K_LEFT]:
            move_sayuu -= 1#10-4：こうかとんの左移動

        if key_lst[pg.K_RIGHT]:
            move_sayuu += 2#10-4：こうかとんの右移動 

        kk_rct.move_ip(move_sayuu, move_jyouge) #10-5：こうかとんの移動       
